...
class InteractingMultipleModelKalmanFilter(KalmanFilter):
    ...
    def fit(self, inputs):
        ...
        _, _, x_hat_pri, x_hat_post, P_pri, P_post, self._kf_ctr = tf.scan(self.kfScan,
                                                                           z,
        ...
        filter_results = super().process_results(x_hat_pri, x_hat_post, P_pri, P_post,z)
    ...
    def kfScan(self, state, z):
        ...
        for model_index, model in enumerate(self.model_list): 
            ...
            # predict
            #########
            x_pri, P_pri = self.predict(x_post_star[model_index],P_post_star[model_index],model)
