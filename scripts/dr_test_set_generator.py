...
dr_params = dict()
dr_params['save_path'] = '/home/mlweiss/Documents/wpi/research/code/dovebirdia/experiments/evaluation/asilomar3/FUNC_taylor_NOISE_cauchy_LOC_na_SCALE_na_TRIALS_1000_SAMPLES_100_DOMAIN_0_100_FEATURES_1_N_3_7.pkl'
dr_params['ds_type'] = 'test'
dr_params['x_range'] = (-1,1)
dr_params['n_trials'] = 10000
...
dr_params['noise'] = (
    ...
    #['bimodal', distributions.bimodal, {'loc1':0.5, 'scale1':0.2, 'loc2':-0.5, 'scale2':0.2}],
