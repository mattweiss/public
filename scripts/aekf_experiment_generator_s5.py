...
project = 'anomaly'
experiment_name = 'model_AEKF_train_A2_OUTLIERS_False'
...
####################################
model_params['hidden_dims'] = [(256,128,32),(128,32) ]
model_params['learning_rate'] = list(np.logspace(-3,-6,4))
kf_params['q'] = list(np.logspace(-4,-8,3))
...
ds_params['saved_dataset'] = '/home/mlweiss/Documents/wpi/research/data/anomaly/s5/ydata-labeled-time-series-anomalies-v1_0/split/s5_A2.pkl'
